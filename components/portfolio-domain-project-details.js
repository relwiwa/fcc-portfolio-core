...
const PortfolioDomainProjectDetails = (props) => {
  ...
  return (
    <div className="portfolio-domain-project-details grid-x grid-padding-x">
      ...
      <p className="cell">The {title} project was implemented based on these <a href={links.freecodecamp} target="blank" title={title + ' project user stories from Freecodecamp'}>user stories</a> stated by FreeCodeCamp:</p>
